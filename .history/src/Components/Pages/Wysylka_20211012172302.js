  ...
  render() {
    return (
      <div className="order-container">
        ...
        <p>Paczki wysyłamy za pośrednictwem kuriera lub paczkomatu. Koszt wysyłki to 25 zł niezależnie od wielkości paczki. Wysyłka zamówień świątecznych złożonych do 10 listopada (w tym kalendarzy adwentowych) będzie realizowana 25 listopada. </p>
        </div>
