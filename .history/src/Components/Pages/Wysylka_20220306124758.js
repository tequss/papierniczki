  ...
  render() {
    return (
      <div className="order-container">
        ...
        <p>Paczki wysyłamy za pośrednictwem kuriera lub paczkomatu. Koszt wysyłki to 20 zł niezależnie od wielkości paczki.</p> <p><b>Zamówienia złożone do 21.03 będą wysłane 28-29.03, późniejsze 11-12.04. Zamówienia przyjmujemy do wyczerpania naszych możliwości przerobowych.</b> </p>
        </div>
