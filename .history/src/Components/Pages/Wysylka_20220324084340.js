  ...
  render() {
    return (
      <div className="order-container">
        ...
        <p>Paczki wysyłamy za pośrednictwem kuriera lub paczkomatu. Koszt wysyłki to 20 zł niezależnie od wielkości paczki.</p> <p><b>Zamówienia przyjmujemy do 4.04. Wysyłki będą realizowane 11-12.04.</b> </p>
        </div>
