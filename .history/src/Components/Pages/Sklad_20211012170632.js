  ...
  render() {
    return (
      <div className="order-container">
        ...
        <p>Piernik: mąka pszenna, miód pszczeli, masło 82%, cukier trzcinowy , żółtko jaja w proszku pasteryzowane, kakao, przyprawa do piernika (może zawierać śladowe ilości glutenu, selera, jaj, gorczycy, soi, sezamu), soda oczyszczona. </p>
        </div>
